...
public class AppInfo_OLD {
    ...
    public AppInfo_OLD(int id, String name, String summary, String price, String currency, String rights, String title, int categoryId, String release, String urlImageCero, String urlImageUno, String urlImageDos) {
        this.id = id;
        this.name = name;
